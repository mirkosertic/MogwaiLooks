    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) {
        ...
        if (pageIndex < pageCount) {
            ...
            if (!hOffSets.containsKey(pageIndex)) {
                BufferedImage bImage = new BufferedImage(dw, dh, BufferedImage.TYPE_INT_ARGB);
                ...
                double dClipY = gTemp.getClipBounds().getY() - (iOriginalClipY) / dZoom;

                if (bDebug) {
                    System.out.println("Original ClipY " + iOriginalClipY + " Height= " + dh + " Full Height= " + th);
                }
                ...
                if (bDebug) {
                    System.out.println("Offset for page " + pageIndex + " = " + iOffset);
                }
                try {
                    if (bDebug) {
                        ImageIO.write(bImage, "png", new File("c:\\bufferimage" + pageIndex + ".png"));
                    }
                } catch (Exception eX) {
                    eX.printStackTrace();
                } // try..catch
            ...
            int iOffSet = hOffSets.containsKey(pageIndex) ? hOffSets.get(pageIndex).intValue() : 0;
            // Print on Printer
            ...
            if (bDebug) {
                System.out.println("---> Clipping for " + pageIndex + " X:" + iClipX + " Y:" + iClipY + " W:" + iClipW
                        + " H:" + iClipH + " OriginalH: " + iClipHOriginal);
            }
            ...
            if (bDebug) {
                System.out.println("---> Translate for " + pageIndex + " X:" + dClipX + " Y:" + dClipY + " OriginalY: "
                        + iOriginalY);
            }
            ...
            String sPageIndex = "Seite " + (pageIndex + 1) + " von " + pageCount;
